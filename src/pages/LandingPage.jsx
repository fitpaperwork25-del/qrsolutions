    ...
    <div style={{ fontFamily: "'Syne', sans-serif", background: "#080808", color: "#F0EDE8", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <nav style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "24px 5%", borderBottom: "1px solid #1a1a1a" }}>
        ...
        <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
          ...
          <button className="cta-btn" style={{ padding: "10px 28px", fontSize: 15 }} onClick={() => handlePlan("starter")}>Start Free</button>
        </div>
      </nav>
      ...
      <section style={{ padding: "100px 5% 80px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center", maxWidth: 1200, margin: "0 auto" }}>
        <div className="fade-up">
          ...
          <p style={{ fontSize: 20, color: "#888", lineHeight: 1.7, marginBottom: 40, maxWidth: 460 }}>
      ...
      <section style={{ padding: "100px 5%", maxWidth: 1200, margin: "0 auto" }}>
        ...
        <h2 style={{ fontSize: "clamp(32px, 4vw, 52px)", fontWeight: 800, textAlign: "center", marginBottom: 16 }}>Pick your square.</h2>
